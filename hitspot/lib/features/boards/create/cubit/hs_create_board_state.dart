...
enum HSCreateBoardUploadState { initial, uploading, error }
...
final class HSCreateBoardState extends Equatable {
  const HSCreateBoardState({
    ...
    this.uploadState = HSCreateBoardUploadState.initial,
    this.errorText,
  });
  ...
  final HSCreateBoardUploadState uploadState;
  ...
  HSCreateBoardState copyWith({
    ...
    HSCreateBoardUploadState? uploadState,
    String? errorText,
  }) {
